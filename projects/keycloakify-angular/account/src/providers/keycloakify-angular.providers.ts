...
import { KcContextLike } from 'keycloakify/account/i18n';
...
export const provideKeycloakifyAngular = (config: KeycloakifyAngularConfig) =>
  makeEnvironmentProviders([
    ...
    },
    {
      ...
      multi: true,
      useFactory:
        (i18nService: I18nService<ReturnType<typeof config.getI18n>['i18n']>, kcContext: KcContext) => async () => {
    ...
    {
      provide: I18N,
      useFactory: (i18nService: I18nService<ReturnType<typeof config.getI18n>['i18n']>) => {
