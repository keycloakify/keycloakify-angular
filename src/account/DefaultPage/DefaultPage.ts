...
const DefaultPage = async (
  ...
  switch (pageId) {
    ...
    case 'applications.ftl':
      ComponentBootstrapPromise = import('@keycloakify/angular/account/pages/applications').then(
    ...
    case 'federatedIdentity.ftl':
      ComponentBootstrapPromise = import('@keycloakify/angular/account/pages/federatedIdentity').then(
