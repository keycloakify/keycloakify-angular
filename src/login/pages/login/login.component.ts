...
@Component({
    ...
    imports: [KcClassDirective, KcSanitizePipe, PasswordWrapperComponent, NgClass],
    providers: [
        {
...
export class LoginComponent extends ComponentReference implements TemplateSlots {
