...
const LoginPageExpiredComponent = (await KcPageStory({})).ComponentBootstrap;
const meta: Meta<typeof LoginPageExpiredComponent> = {
  component: LoginPageExpiredComponent,
  decorators: [
    applicationConfig({
      providers: [
