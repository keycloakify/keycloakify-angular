...
const LoginRecoveryAuthnCodeInputComponent = (await KcPageStory({})).ComponentBootstrap;
const meta: Meta<typeof LoginRecoveryAuthnCodeInputComponent> = {
  component: LoginRecoveryAuthnCodeInputComponent,
  decorators: [
    applicationConfig({
      providers: [
