...
const LoginUpdatePasswordComponent = (await KcPageStory({})).ComponentBootstrap;
const meta: Meta<typeof LoginUpdatePasswordComponent> = {
  component: LoginUpdatePasswordComponent,
  decorators: [
    applicationConfig({
      providers: [
